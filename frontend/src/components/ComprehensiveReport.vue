    ...
    <div v-if="report && !loading" class="report-content">
      ...
      <div class="report-header">
        ...
        <div class="user-info">
          ...
          <p><strong>评估机构：</strong>迅佰汇组织领导力测评与咨询</p>
        </div>
      ...
      <div class="report-section intro-section">
        ...
        <div class="text-block">
          ...
          <h3>阅读者</h3>
          <p>本报告仅限于被测评人本人、被测评人直接上级、人力资源部以及迅佰汇项目顾问使用，用途限于被测评人个体能力的持续发展。任何其它组织或个人未经许可，不得擅自阅读、传播、复制或以其它形式使用本报告中的任何内容。</p>

          <h3>报告的有效性</h3>
          <p>本次测评基于迅佰汇组织领导力模型对管理者的领导力要求，对被测评人的行为进行评价。个人的能力素质是不断发展的，特别是在经历重大事件、经受重大挑战之后，素质的提升会很迅速。因此，请留意这份报告的撰写日期和撰写目的。在完成这份报告三年之后，或该参与者或其工作环境发生了巨大变化，如果仍需用该报告作参考，必须慎重考虑其有效性。</p>
      ...
      <div class="report-section indicators-section">
        ...
        <p class="section-intro">本次领导力测评是基于迅佰汇组织领导力模型的{{ getLeadershipItemsCount() }}项领导力素质。</p>
      ...
      <div class="report-section radar-section">
        ...
        <p class="section-intro">对照迅佰汇组织领导力模型对{{ getRoleTextForProfile() }}的领导力要求，参与者在各个能力维度的得分如下。</p>
